...
/**
 * ClassName: XmProcessTemplate
 * Package: com.xiaomi.info.model.process
 * Description:
 *
 * @Author 朱安迪
 * @Create 2024/5/22 13:48
 * @Version 1.0
 */
@Data
@ApiModel(description = "XmProcessTemplate")
@TableName("xm_process_template")
public class XmProcessTemplate extends BaseEntity {
